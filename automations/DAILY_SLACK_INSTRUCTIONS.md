...
1. Read pre-aggregated `JEENY_PROD.RIDE.PRICESHOCKS` (BI refreshes before 11:00 AM PKT)
...
It reads `JEENY_PROD.RIDE.PRICESHOCKS` and returns:
...
Columns: `pct`, `dod_pp`, `wow_pp`, `mom_pp`, `country`, `city_bucket`, `metric_name`.
