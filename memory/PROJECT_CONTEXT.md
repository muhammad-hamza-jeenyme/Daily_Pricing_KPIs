...
Last updated: 2026-08-04 (14d watch rule + Canvas detail; Snowflake MCP required for live digests)
...
3. Confirm automation cron is `30 6 * * *` (not `0 6 * * *`)
